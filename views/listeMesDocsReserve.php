              ...
              <div class="card-body">
                    ...
                    <th>Document</th>
                                ...
                                <tbody class='font-weight-normal'>
									<?php while($et=$affMesDocsReserve->fetch()){?>
									<tr>
										...
										<td <?php if($et['lib_op_doc']=="demande de reservation"){ echo 'class="bg-warning"'; }else{ echo 'class="alert-success"'; } ?>><?php echo($et['lib_op_doc'])?></td>
										...
										<!---SUPPRESSION--<?php if($et['lib_op_doc']=="demande d'emprunt"){echo '
											<a onclick="return confirm(\'la demande sera annulée. Confirmer ?\');" style="text-decoration: none;" href="?c=supprMesOuvEmprunte&code='.$et['id_op'].'">
