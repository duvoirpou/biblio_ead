    ...
    <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">annuler l'emprunt</strong>
              </div>
...
?>
				...
				<div class="form-group" hidden>
					...
					<div align="center">
						<button type="submit" class="btn btn-default" onclick="return confirm('Confirmer la modification ?');" name="modifOuvEmprunte">OK</button>
					</div>
				</form>	
