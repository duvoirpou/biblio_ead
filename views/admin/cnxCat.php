<?php
if(isset($_POST['enregistre']) AND !empty($_POST['lib_cat_ouv'])){
$cnom = 'info';
        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">SELCTIONNEZ LA CATéGORIE DE L'OUVRAGE</strong>
              </div>
              ...
              <div class="card-body"><!--<a href="?c=AjoutCatOuv" style="text-decoration: none"><h5>créer une nouvelle catégorie</h5></a>-->
					...
					<?php if(isset($_COOKIE[$cnom])){ if($_SESSION['info'] == 'Cette catégorie existe déjà'){ echo '<div class="alert alert-danger" role="alert">'.$_COOKIE[$cnom].'
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Créer une nouvelle catégorie</h4>
        ...
        <div class="modal-body">
													...
													<div class="form-group">
														<label for="lib_cat_ouv"></label>
														<input id="lib_cat_ouv" name="lib_cat_ouv" type="text" value="" style="  height:26px" placeholder="Catégorie" class="form-control"/>
          ...
          <button type="button" class="btn btn-danger" data-dismiss="modal">Fermer</button>
								...
								<form method="POST" style="" action=""> 
									<h4></h4>
													<div class="form-group">
														<label for="lib_cat_ouv"></label>
															<select class="form-control" id="lib_cat_ouv" name="lib_cat_ouv" style="">
																<option value=""></option>
																<?php while($et=$aff->fetch()){?>
																
																<option value="<?php echo($et['lib_cat_ouv'])?>"><?php echo($et['lib_cat_ouv'])?></option>
