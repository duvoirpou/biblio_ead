<?php
if(isset($_POST['enregistre']) AND !empty($_POST['lib_rayon'])){
$cnom = 'info';
...
<?php include('header.php'); ?> 
        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">entrez le rayon dans lequel sera enrégistré l'ouvrage</strong>
              </div>
		...
		<?php if(isset($_COOKIE[$cnom])){ if($_SESSION['info'] == 'Ce rayon existe déjà'){ echo '<div class="alert alert-danger" role="alert">'.$_COOKIE[$cnom].'
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
													...
													<div class="form-group">
														<label for="lib_rayon"></label>
														<input id="lib_rayon" name="lib_rayon" type="text" value="" style="  height:26px" placeholder="Rayon" class="form-control"/>
