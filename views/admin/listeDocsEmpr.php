        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">demandes d'umprunts en attente</strong>
              </div>
          ...
          <thead class="text-center" style="/*background-color: #6c757d*/">
							...
							<tbody class='font-weight-normal'>
									...
									<tr>
										...
										<td class="alert-warning"><?php echo($et['lib_op_doc'])?></td>
										...
										<td style="text-align:center;">
											<a style="text-decoration: none;" href="?c=modifDocsEmpr&code=<?php echo($et['id_op_doc'])?>">
												<button  class="btn btn-primary btn-sm btn-block" type="submit" style=""><i class="fa fa-edit"></i> MODIFIER</button>
											</a>						
										<!---SUPPRESSION--
											<a class="a_lien" onclick="return confirm('Confirmer la suppression ?');" style="text-decoration: none;" href="?c=supprOuv&code=<?php echo($et['id_doc'])?>">
												SUPPRIMER
											</a>-->
										</td>
									</tr>	
