        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">demandes de réservation en attente</strong>
              </div>
              
              <div class="card-body">
								<p ><h5 class="text-center"><?php echo $_SESSION['docs_res'] ?> demande<?php if($_SESSION['docs_res']>1){ echo 's'; } ?></h5></p>
...
<!--										<td ><?php echo($et['id_doc'])?></td>-->
										...
										<td class="alert-warning"><strong><?php echo($et['lib_op_doc'])?></strong></td>
										...
										<td style="text-align:center;">
											<a class="a_lien" style="text-decoration: none;" href="?c=modifDocsRes&code=<?php echo($et['id_op_doc'])?>">
