<?php
if(isset($_POST['enregistre']) AND !empty($_POST['lib_comp'])){
$cnom = 'info';
...
<?php include('header.php'); ?> 
        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">entrez le compartiment dans lequel sera enrégistré l'ouvrage</strong>
              </div>
		...
		<?php if(isset($_COOKIE[$cnom])){ if($_SESSION['info'] == 'Ce compartiment existe déjà'){ echo '<div class="alert alert-danger" role="alert">'.$_COOKIE[$cnom].'
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Créer un nouveau compartiment</h4>
        ...
        <div class="modal-body">
													...
													<div class="form-group">
														<label for="lib_comp"></label>
														<input id="lib_comp" name="lib_comp" type="text" value="" style="  height:26px" placeholder="Compartiment" class="form-control"/>
													...
													<div class="form-group">
														<label for="id_rayon"></label>
														<select class="form-control" id="id_rayon" name="id_rayon" style="">
																<option value=""></option>
																<?php while($et=$affRayon->fetch()){?>
																
																<option value="<?php echo($et['id_rayon'])?>"><?php echo($et['lib_rayon'])?></option>
