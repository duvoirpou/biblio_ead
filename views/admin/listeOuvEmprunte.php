...
<?php include('header.php'); ?> 
               ...
               <div class="modal-content">
                   ...
                   <form method="post" action="" id="confirm">
                       <div class="modal-body">
                           ...
                           <input type="hidden" name="lib_op" id="lib_op">
            ...
            <div class="card card-default"><!-- content -->
              ...
              <div class="card-body">
								<div class="alert text-center font-weight-bold" role="alert">
									<h4 >Vous avez
										<a href="?c=AdmlisteEmp" style="text-decoration: none"><?php echo $_SESSION['ouv_empr'].' demande(s) d\'emprunt'; ?></a>
										&
										<a href="?c=AdmlisteRes" style="text-decoration: none"><?php echo $_SESSION['ouv_res'].' demande(s) de réservation'; ?></a>
										<?php if($_SESSION['ouv_res']>0 OR $_SESSION['ouv_empr']>0){ echo 'en attente...';}  ?>
									</h4>
								</div>
								<!--<p><a href="#" style="text-decoration: none">Voir la liste des ouvrages empruntés</a></p>-->
								<div class="table-responsive" style="">
								<table id="tabOuvr" class="table table-bordered table-striped table-sm">
   ...
   <script src="assets/js/ouv_emprunte.js"></script>
  </body>
</html>