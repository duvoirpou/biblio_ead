        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">entrez les nom et prénom du directeur de mémoire</strong>
              </div>
              
              <div class="card-body">
                 <div id="container" style="" align="center">
									
<?php if(isset($_COOKIE[$cnom])){ if($_SESSION['info'] == 'Ce DM existe déjà'){ echo '<div class="alert alert-danger" role="alert">'.$_COOKIE[$cnom].'
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Créer un nouveau directeur de mémoire</h4>
        ...
        <div class="modal-body">
													...
													<div class="form-group">
														<label for="nom_dm"></label>
														<input id="nom_dm" name="nom_dm" type="text" value="" style="  height:26px" placeholder="Nom du DM" class="form-control"/>
													...
													<div class="form-group">
														<label for="prenom_dm"></label>
														<input id="prenom_dm" name="prenom_dm" type="text" value="" style="  height:26px" placeholder="Prénom du DM" class="form-control"/>
                              
													</div>
													
													<div class="form-group text-left">
                          <label for="sexe">Sexe</label>
													<select class="form-control" id="sexe_dm" name="sexe_dm" >
                                                            <option value=""></option>
													...
													<div class="form-group">
														<label for="grade_dm"></label>
														<input id="grade_dm" name="grade_dm" type="text" value="" style="  height:26px" placeholder="Grade du DM" class="form-control"/>
                              
													</div>
													
													
													<div class="form-group">
														<label for="fonction_dm"></label>
														<input id="fonction_dm" name="fonction_dm" type="text" value="" style="  height:26px" placeholder="Fonction du DM" class="form-control"/>
