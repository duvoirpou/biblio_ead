    ...
    <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">annuler la reservation</strong>
              </div>
              ...
              <div class="card-body">
					...
					<div class="form-group" hidden>
						...
						<input type="number" name="id_ouvrage" value ="<?php echo($op['id_ouvrage'])?>" class="form-control"/>
					</div>
					...
					<div class="form-group" >
						...
						<select class="form-control" id="operation" name="operation" style="">
																
																
																
																<option value="<?php echo($op['operation'])?>"></option>
																<option value="0">Oui, annuler.</option>
					...
					<div class="form-group" hidden>
						...
						<input type="text" name="date_debut_op" value ="<?php echo($op['date_debut_op'])?>" class="form-control"/>
					</div>
					
					
					<div class="form-group" hidden>
						<label class="control-label">heure_debut_op : </label>
						<input type="text" name="heure_debut_op" value ="<?php echo($op['heure_debut_op'])?>" class="form-control"/>
					</div>
...
?>
					...
					<div class="form-group" hidden>
						...
						<input type="text" name="date_fin_op" value ="<?PHP echo ($date_jour) ?>" class="form-control"/>
					</div>
					
					
					<div class="form-group" hidden>
						<label class="control-label">heure_fin_op : </label>
						<input type="text" name="heure_fin_op" value ="<?php echo($heure)?>" class="form-control"/>
					</div>
				...
				<div class="form-group" hidden>
					...
					<div align="center">
						<button type="submit" class="btn btn-default" onclick="return confirm('Confirmer la modification ?');" name="modifOuvReserve">OK</button>
					</div>
				</form>	
