        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <div class="card-body">
								<!--<p><a href="?c=AdmlisteEmprunte" style="text-decoration: none"><h5>Voir la liste des ouvrages empruntés</h5></a></p>-->
									...
									<tr>
										...
										<td style="text-align:center;">
											<a class="a_lien" style="text-decoration: none;" href="?c=modifOuvEmpr&code=<?php echo($et['id_op'])?>">
												<button  class="btn btn-primary btn-block btn-sm" type="submit" style=""><i class="fa fa-edit"></i> MODIFIER</button>
											</a>						
										<!---SUPPRESSION--
