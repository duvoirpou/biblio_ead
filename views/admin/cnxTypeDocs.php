<?php
if(isset($_POST['enregistre']) AND !empty($_POST['lib_type_doc'])){
$cnom = 'info';
        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col-xs-12 col-sm-12 col-md-12" style="">
            <div class="card card-default"><!-- content -->
              ...
              <strong class="">SELeCTIONNEZ Le type DE document</strong>
              </div>
              
              <div class="card-body"><!--<a href="?c=AjoutCatOuv" style="text-decoration: none"><h5>créer une nouvelle catégorie</h5></a>-->
								<div id="container" style="" align="center">
          
					
					<?php if(isset($_COOKIE[$cnom])){ if($_SESSION['info'] == 'Ce type de document existe déjà'){ echo '<div class="alert alert-danger" role="alert">'.$_COOKIE[$cnom].'
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Créer un nouveau type de document</h4>
        ...
        <div class="modal-body">
													...
													<div class="form-group">
														<label for="lib_type_doc"></label>
														<input id="lib_type_doc" name="lib_type_doc" type="text" value="" style="  height:26px" placeholder="Type" class="form-control"/>
          ...
          <button type="button" class="btn btn-danger" data-dismiss="modal">Fermer</button>
								...
								<form method="POST" style="" action=""> 
									<h4></h4>
													<div class="form-group">
														<label for="lib_type_doc"></label>
															<select class="form-control" id="lib_type_doc" name="lib_type_doc" style="">
																<option value=""></option>
																<option value="Mémoire">Mémoire</option>
																<option value="Rapport de stage">Rapport de stage</option>
																<?php //while($et=$aff->fetch()){?>
																
																<!-- <option value="<?php echo($et['lib_type_doc'])?>"><?php echo($et['lib_type_doc'])?></option> -->
