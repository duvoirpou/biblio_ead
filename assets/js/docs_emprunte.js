$(document).ready(function(){
    ...
    var dataTable = $('#tabDocs').DataTable({
        "processing":true,
        "serverSide":true,
        "order":[],
        "ajax":{
            url:"affiche_docs_emprunte.php",
            method: "POST"
        },
        "columnDefs":[
            {
    ...
    $(document).on('click', '.suppr', function(){
        ...
        $.ajax({
            url: "save_supp_op_docs.php",
            method: "POST",
            data: {id : id},
            dataType: "json",
            success: function(data){

                $('#id_conf').val(data.id_op_doc);
                $('#lib_op_doc').val(data.lib_op_doc);
...
$('#msg').html('');
    ...
    $(document).on('submit', '#confirm', function (e) {
        ...
        $.ajax({
            url: "action_adm_supp_op_docs.php",
            method: "POST",
            data: data,
            success: function(data){
