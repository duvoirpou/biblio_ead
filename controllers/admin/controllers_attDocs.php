...
if(isset($_POST['valider'])){
		...
		$AjouterOperation_docs = new Operations_docs(NULL, $lib_op_doc, $id_etudiant, $id_doc, $date_demande_op, $heure_demande_op, $date_debut_op, $heure_debut_op, $date_fin_op, $heure_fin_op, $jour_op, $mois_op, $annee_op);
	
		$reponse = $AjouterOperation_docs->ajoutOperations_docs();
...
include ('views/admin/formAttDocs.php');
?>