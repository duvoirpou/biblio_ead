<?php
	...
	if(isset($_POST['modifOuvEmpr'])){
		...
		$ModifierOperations = new Operations($id_op,$lib_op,$id_etudiant,$id_exp,$operation,$date_demande_op,$heure_demande_op,$date_debut_op,$heure_debut_op,$date_fin_op,$heure_fin_op,$jour_op,$mois_op,$annee_op);
	
		$reponse = $ModifierOperations->ModifierOuvEmpr();
		
		if($reponse){
			header('location:?c=AdmlisteEmp');
		}
	}
	...
	include('views/admin/formAffOuvEmpr.php');
